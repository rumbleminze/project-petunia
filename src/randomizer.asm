...
LVL_PLATFORMS 		        = $6300
.DEFINE LVL_1_PLATFORMS $7B60
.DEFINE LVL_2_PLATFORMS $BDB3
.DEFINE LVL_3_PLATFORMS $769b
...
donewithmusic:
    jsr populateenemies
	jsr clear_centurions
	jsr populate_enemy_positions_for_randomizer
	jsr grant_items
    RTL
...
cenurion_indexes:
.byte $00, $00, $00, $00, $00, $03, $00, $06

centurion_offsets:
.byte $BB, $71, $3A ; Level 1-4, $3B centurions starting at 71BB, we go from 3a to 0
.byte $BB, $71, $41 ; Level 2-4, $42 starting at 71BB
.byte $BB, $71, $28 ; Level 3-4, Not done yet
...
clear_centurions:	
	...
	LDA CURRENT_LEVEL_IDX ; 3 = 1-4, 5 = 2-4, 7 = 3-4
	TAY
	LDA cenurion_indexes, Y
	TAY

	lda centurion_offsets, Y
	STA $00
	INY
	lda centurion_offsets, y
	STA $01
...
; 716f
.define ENEMY_POSITION_WRITE $716F
; gets written to 716F
randomized_dungeon_enemy_positions:
.byte $44, $74, $A8, $7C, $44, $6D, $A2, $AA, $74, $56, $5A, $7B, $73, $77, $7D, $AA
.byte $44, $A3, $19, $AD, $A2, $54, $49, $AC, $48, $77, $73, $7A, $56, $5A, $A5, $AD
.byte $4C, $64, $8C, $A4, $43, $01, $4C, $01, $76, $00, $8D, $00, $75, $02, $75, $00
.byte $75, $03, $8A, $00, $83, $01, $86, $01, $89, $01, $8C, $01, $35, $03, $65, $03
.byte $86, $03, $8A, $02, $44, $A6, $A5, $AA, $35, $87, $75, $7A

populate_enemy_positions_for_randomizer:	
	LDY #$00
:	lda randomized_dungeon_enemy_positions, Y
	STA ENEMY_POSITION_WRITE, Y
	INY
	CPY #$4C
	BNE :-
	RTS
